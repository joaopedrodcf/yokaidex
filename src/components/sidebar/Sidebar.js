    ...
    return (
        <Wrapper>
            <Sections>
                ...
                <SCNavLink to={`/yokai-watch-${context.gameVersion}`} exact>
                    <Book /> Medallium
                </SCNavLink>
                ...
                <SCNavLink to={`/yokai-watch-${context.gameVersion}/items`}>
                    <Briefcase /> Items
                </SCNavLink>
                <SCNavLink
                ...
                <SCNavLink to={`/yokai-watch-${context.gameVersion}/about-us`}>
                    <Info /> About us
                </SCNavLink>
            </Sections>
            <Sections showBorder>
